...
//			responseNews(items);
			...
			responseText("<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5817e3c05201c96d&redirect_uri=http://zhangjiaqi.top/wechat/Login&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'>login</a>");
		}
		// sfdasdfasdfasdfasdfsdafsdfdasfasdfsdaffdsafsdafasdfasdfsfasdfdfsaffsd
		else{
